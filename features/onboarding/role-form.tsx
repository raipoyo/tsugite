...
export default function RoleForm({ error }: { error?: string }) {
  ...
  return (
    <div className="mx-auto grid max-w-2xl gap-4 md:grid-cols-2">
      {error === 'failed' ? (
        <p className="col-span-full text-sm text-red-600 md:col-span-2">
      ...
      <div className="flex flex-col gap-3 rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
        <h2 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50">店（掲載者）</h2>
      ...
      <div className="flex flex-col gap-3 rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
        <h2 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50">継ぎ手</h2>
        <p className="flex-1 text-sm text-zinc-600 dark:text-zinc-400">
